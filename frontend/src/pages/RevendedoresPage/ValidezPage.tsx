...
export default function ValidezPage({ isMobileMenuOpen: _isMobileMenuOpen, setIsMobileMenuOpen: _setIsMobileMenuOpen }: { isMobileMenuOpen: boolean, setIsMobileMenuOpen: (v: boolean) => void }) {
        ...
        <section className="relative py-12 sm:py-16 lg:py-20 bg-refine-dark">
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="w-full">
              <PlanGroupsSection groups={groupedPlans} onConfirmarCompra={handleConfirmarCompra} initialGroupId="validez" />
            </div>
          </div>
        </section>
