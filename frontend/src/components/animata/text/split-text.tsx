...
export default function SplitText({
  ...
  return (
    <div
      className={cn(
        "relative mx-auto cursor-default text-4xl font-black uppercase text-yellow-500 md:text-5xl lg:text-9xl",
        className,
      )}
    >
      ...
      <div className="absolute top-0 flex h-full">
        {text.split("").map((letter, index) => (
          <div
            ...
            key={index}
            className="relative inline-flex h-full cursor-default flex-col leading-none"
          >
            {/** top half */}
            <span
